...
BurnhopePipeline::~BurnhopePipeline() {
    ...
    vkDestroyShaderModule(lveDevice.device(), compShaderModule, nullptr); // Добавили
    vkDestroyPipeline(lveDevice.device(), graphicsPipeline, nullptr);
    vkDestroyPipeline(lveDevice.device(), computePipeline, nullptr);      // Добавили
}
...
// 2. Уничтожение (обнови свой деструктор!)
